...
<!-- <script type="text/javascript" scr="https://js.stripe.com/v2/"></script> -->
<script src="https://js.stripe.com/v2/"></script>;
 ...
 function update_cart(mode,edit_id,edit_size){
   var data = {"mode" : mode, "edit_id" : edit_id, "edit_size" : edit_size};
    // var data = {mode:"mode", edit_id:"edit_id", edit_size:"edit_size"};
    jQuery.ajax({
      url: '/fuckIDE/admin/parsers/update_cart.php',
      method: "post",
      data: data,
      success: function(){
        location.reload();
  ...
  function check_address(){
    var data = {
      ...
      jQuery.ajax({
        url : '/fuckIDE/admin/parsers/check_address.php',
        method : "post",
        data : data,
        success: function(data){
          ...
          if(data == 'passed'){
            ...
            jQuery('#myModalLabel').html("Enter Your Card Details");

          }

        },
        error: function(){
          alert("Something on wrong");
        }
    ...
    function back_address(){
      ...
      jQuery('#myModalLabel').html("Shipping Address");
...
<div class ="col-md-12">
  <div class="row">
    ...
    <?php else: ?>
      ...
      <!-- Modal-->
      <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelleby="myModalLable">
      ...
      <form action = "thankYou.php" method ="post" id="payment-form">
            <span class="bg-danger" id="payment_errors"></span>
                ...
                <input type="hidden" name="description" value="<?=$item_count.' item'.(($item_count>1)?'s':'').'from hary kane.' ;?>">
